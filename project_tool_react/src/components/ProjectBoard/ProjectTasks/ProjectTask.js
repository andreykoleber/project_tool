...
class ProjectTask extends Component {
    ...
    onDeleteClick(backlogId, projectSequence) {
        this.props.deleteProjectTask(backlogId, projectSequence);
    }
    ...
    render() {
        ...
        return (
            <div className="card mb-1 bg-light">
                <div className={`card-header text-primary ${priorityClass}`}>ID:  {projectTask.projectSequence} -- Priority: {priorityString}</div>
